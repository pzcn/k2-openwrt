...
curl -o target/linux/generic/hack-5.4/662-remove_pfifo_fast.patch https://raw.githubusercontent.com/coolsnowwolf/lede/707e6ed1a19db0a12f553cafbd5851d3591420af/target/linux/generic/hack-5.4/662-remove_pfifo_fast.patch
